...
feature {NONE} -- Initialization
	...
	make_with_attributes (odom_sig: separate ODOMETRY_SIGNALER; r_group: separate RANGE_SENSOR_GROUP;
				g_group: separate GROUND_SENSOR_GROUP; d_drive: separate DIFFERENTIAL_DRIVE; s_player: separate SOUND_PLAYER)
...
feature {NONE} -- Implementation
	...
	range_group: separate RANGE_SENSOR_GROUP
			-- Horizontal range sensors.

	ground_group: separate GROUND_SENSOR_GROUP
			-- Ground sensors.
