...
feature -- Access
	...
	is_obstacle_at_left: BOOLEAN
			-- Whether an obstacle is observed at left?

	is_obstacle_at_right: BOOLEAN
			-- Whether an obstacle is observed at right?

	is_obstacle_huge: BOOLEAN
			-- Whether an obstacle is observed by all sensors of the side?
	...
	is_sensor_blocked (a_sensor_index: INTEGER): BOOLEAN
		...
		do
			Result := sensors[a_sensor_index].is_valid_range
		end
