...
extern EIF_TYPED_VALUE F509_2425(EIF_REFERENCE);
extern void F509_2428(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F509_7344(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F509_2425 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 508, Current, 0, 0, 2706);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(508, Current, 2706);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F509_2428 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 508, Current, 0, 1, 2707);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(508, Current, 2707);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2084, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	uu8_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2086, dtype))(Current, uu8_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F509_7344 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 508, Current, 0, 7343);
	RTSA(dtype);
	RTME(dtype, 0);
