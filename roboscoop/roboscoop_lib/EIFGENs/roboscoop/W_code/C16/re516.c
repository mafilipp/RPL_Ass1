...
extern EIF_TYPED_VALUE F516_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F516_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 515, Current, 0, 0, 3586);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(515, Current, 3586);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000200, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {512,0,0xFFFF};
