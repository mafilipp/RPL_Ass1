...
extern EIF_TYPED_VALUE F511_3339(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F511_3340(EIF_REFERENCE);
extern EIF_TYPED_VALUE F511_3341(EIF_REFERENCE);
extern void F511_7358(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F511_3339 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 510, Current, 2, 1, 4865);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(510, Current, 4865);
	RTCC(arg1, 510, l_feature_name, 1, eif_attached_type(Dftype(Current)));
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1984, "item", arg1))(arg1)).it_n8);
...
/* {LIST}.after */
EIF_TYPED_VALUE F511_3340 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 510, Current, 0, 0, 4866);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(510, Current, 4866);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F511_3341 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 510, Current, 0, 0, 4867);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(510, Current, 4867);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F511_7358 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 510, Current, 0, 7357);
	RTSA(dtype);
	RTME(dtype, 0);
