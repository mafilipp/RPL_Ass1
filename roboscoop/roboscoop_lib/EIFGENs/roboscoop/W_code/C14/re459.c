...
extern EIF_TYPED_VALUE F459_2271(EIF_REFERENCE);
extern EIF_TYPED_VALUE F459_2272(EIF_REFERENCE);
extern EIF_TYPED_VALUE F459_2273(EIF_REFERENCE);
extern EIF_TYPED_VALUE F459_2274(EIF_REFERENCE);
extern void F459_2275(EIF_REFERENCE);
extern void F459_7338(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F459_2271 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F459_2272 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F459_2273 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 2357);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 2357);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F459_2274 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 2358);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(458, Current, 2358);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F459_2275 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 2359);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 2359);
	RTIV(Current, RTAL);
...
void F459_7338 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 458, Current, 0, 7337);
	RTSA(dtype);
	RTME(dtype, 0);
