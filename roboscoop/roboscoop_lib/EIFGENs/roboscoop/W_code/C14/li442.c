...
extern void F442_3748(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F442_3749(EIF_REFERENCE);
extern EIF_TYPED_VALUE F442_3750(EIF_REFERENCE);
extern EIF_TYPED_VALUE F442_3751(EIF_REFERENCE);
extern void F442_7366(EIF_REFERENCE, int);
...
void F442_3748 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 441, Current, 0, 3, 5142);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(441, Current, 5142);
	RTCC(arg1, 441, l_feature_name, 1, RTWCT(2834, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 2834, 0xF80001B8, 0); /* active */
...
EIF_TYPED_VALUE F442_3749 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F442_3750 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F442_3751 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F442_7366 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 441, Current, 0, 7365);
	RTSA(dtype);
	RTME(dtype, 0);
