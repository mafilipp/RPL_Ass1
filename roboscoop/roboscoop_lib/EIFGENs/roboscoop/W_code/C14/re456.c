...
extern EIF_TYPED_VALUE F456_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F456_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 455, Current, 0, 0, 3584);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(455, Current, 3584);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80001C4, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {452,0,0xFFFF};
