...
extern EIF_TYPED_VALUE F489_2271(EIF_REFERENCE);
extern EIF_TYPED_VALUE F489_2272(EIF_REFERENCE);
extern EIF_TYPED_VALUE F489_2273(EIF_REFERENCE);
extern EIF_TYPED_VALUE F489_2274(EIF_REFERENCE);
extern void F489_2275(EIF_REFERENCE);
extern void F489_7338(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F489_2271 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F489_2272 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F489_2273 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 488, Current, 0, 0, 2363);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(488, Current, 2363);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F489_2274 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 488, Current, 0, 0, 2364);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(488, Current, 2364);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F489_2275 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 488, Current, 0, 0, 2365);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(488, Current, 2365);
	RTIV(Current, RTAL);
...
void F489_7338 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 488, Current, 0, 7337);
	RTSA(dtype);
	RTME(dtype, 0);
