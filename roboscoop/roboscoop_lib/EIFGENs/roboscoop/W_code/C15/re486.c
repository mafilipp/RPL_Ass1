...
extern EIF_TYPED_VALUE F486_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F486_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 485, Current, 0, 0, 3585);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(485, Current, 3585);
	RTIV(Current, RTAL);
	RTHOOK(1);
