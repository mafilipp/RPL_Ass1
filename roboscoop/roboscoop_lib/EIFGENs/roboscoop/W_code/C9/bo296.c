...
extern EIF_TYPED_VALUE F296_2268(EIF_REFERENCE);
extern void F296_7336(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F296_2268 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 295, Current, 0, 0, 2301);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(295, Current, 2301);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F296_7336 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 295, Current, 0, 7335);
	RTSA(dtype);
	RTME(dtype, 0);
