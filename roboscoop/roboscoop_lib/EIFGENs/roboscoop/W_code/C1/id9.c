...
extern EIF_TYPED_VALUE F9_53(EIF_REFERENCE);
extern void F9_54(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F9_53 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 8, Current, 0, 0, 68);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(8, Current, 68);
	RTIV(Current, RTAL);
...
void F9_54 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 8, Current, 0, 1, 69);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(8, Current, 69);
	RTIV(Current, RTAL);
