...
extern EIF_TYPED_VALUE F716_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F716_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 715, Current, 0, 0, 3591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(715, Current, 3591);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80002C8, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {712,0,0xFFFF};
