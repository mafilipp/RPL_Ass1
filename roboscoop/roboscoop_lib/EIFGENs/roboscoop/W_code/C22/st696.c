...
extern void F696_2264(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F696_2265(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F696_2264 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 695, Current, 0, 1, 2297);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(695, Current, 2297);
	RTCC(arg1, 695, l_feature_name, 1, RTWCT(1984, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F696_2265 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 695, Current, 1, 1, 2298);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(695, Current, 2298);
	{
		EIF_TYPE_INDEX typarr0[] = {288,0,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[1] = RTWCT(1943, dtype, Dftype(Current));
		
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		RTCC(arg1, 695, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(3);
	RTDBGAL(Current, 1, 0xF80002B6, 0, 0); /* loc1 */
	
	{
		EIF_TYPE_INDEX typarr0[] = {694,0,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[1] = RTWCT(1943, dtype, Dftype(Current));
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(6);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2015, "item", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
