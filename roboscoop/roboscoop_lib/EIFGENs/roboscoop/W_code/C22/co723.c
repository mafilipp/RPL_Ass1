...
extern EIF_TYPED_VALUE F723_2180(EIF_REFERENCE);
extern EIF_TYPED_VALUE F723_2181(EIF_REFERENCE);
extern EIF_TYPED_VALUE F723_2182(EIF_REFERENCE);
extern void F723_2183(EIF_REFERENCE);
extern void F723_2184(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F723_2180 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 722, Current, 0, 0, 2136);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(722, Current, 2136);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F723_2181 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F723_2182 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 722, Current, 0, 0, 2138);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(722, Current, 2138);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F723_2183 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 722, Current, 0, 0, 2139);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(722, Current, 2139);
	RTIV(Current, RTAL);
...
void F723_2184 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 722, Current, 0, 0, 2140);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(722, Current, 2140);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
