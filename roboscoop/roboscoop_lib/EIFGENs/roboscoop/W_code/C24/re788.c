...
extern EIF_TYPED_VALUE F788_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F788_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 787, Current, 0, 0, 3593);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(787, Current, 3593);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000310, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {784,0,0xFFFF};
