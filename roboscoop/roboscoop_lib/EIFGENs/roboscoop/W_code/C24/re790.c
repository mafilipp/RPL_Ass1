...
extern EIF_TYPED_VALUE F790_2271(EIF_REFERENCE);
extern EIF_TYPED_VALUE F790_2272(EIF_REFERENCE);
extern EIF_TYPED_VALUE F790_2273(EIF_REFERENCE);
extern EIF_TYPED_VALUE F790_2274(EIF_REFERENCE);
extern void F790_2275(EIF_REFERENCE);
extern void F790_7338(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F790_2271 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F790_2272 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F790_2273 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 789, Current, 0, 0, 2411);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(789, Current, 2411);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F790_2274 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 789, Current, 0, 0, 2412);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(789, Current, 2412);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F790_2275 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 789, Current, 0, 0, 2413);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(789, Current, 2413);
	RTIV(Current, RTAL);
...
void F790_7338 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 789, Current, 0, 7337);
	RTSA(dtype);
	RTME(dtype, 0);
