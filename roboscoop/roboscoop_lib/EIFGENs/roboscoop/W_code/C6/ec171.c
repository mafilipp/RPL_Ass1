...
extern EIF_TYPED_VALUE F171_2950(EIF_REFERENCE);
...
EIF_TYPED_VALUE F171_2950 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 170, Current, 0, 0, 3017);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(170, Current, 3017);
	RTIV(Current, RTAL);
	RTHOOK(1);
