...
extern void F205_4832(EIF_REFERENCE);
extern EIF_TYPED_VALUE F205_4833(EIF_REFERENCE);
...
void F205_4832 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 204, Current, 2, 0, 7088);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(204, Current, 7088);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F205_4833)
EIF_TYPED_VALUE F205_4833 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 204, Current, 0, 0, 7089);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(204, Current, 7089);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
