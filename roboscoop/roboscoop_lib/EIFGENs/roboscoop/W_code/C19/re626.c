...
extern EIF_TYPED_VALUE F626_2271(EIF_REFERENCE);
extern EIF_TYPED_VALUE F626_2272(EIF_REFERENCE);
extern EIF_TYPED_VALUE F626_2273(EIF_REFERENCE);
extern EIF_TYPED_VALUE F626_2274(EIF_REFERENCE);
extern void F626_2275(EIF_REFERENCE);
extern void F626_7338(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F626_2271 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F626_2272 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F626_2273 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 625, Current, 0, 0, 2387);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(625, Current, 2387);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F626_2274 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 625, Current, 0, 0, 2388);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(625, Current, 2388);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F626_2275 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 625, Current, 0, 0, 2389);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(625, Current, 2389);
	RTIV(Current, RTAL);
...
void F626_7338 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 625, Current, 0, 7337);
	RTSA(dtype);
	RTME(dtype, 0);
