...
extern EIF_TYPED_VALUE F625_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F625_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 624, Current, 0, 0, 3589);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(624, Current, 3589);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800026D, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {621,0,0xFFFF};
