...
extern EIF_TYPED_VALUE F727_2268(EIF_REFERENCE);
extern void F727_7336(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F727_2268 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 726, Current, 0, 0, 2323);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(726, Current, 2323);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F727_7336 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 726, Current, 0, 7335);
	RTSA(dtype);
	RTME(dtype, 0);
