...
extern EIF_TYPED_VALUE F749_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F749_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 748, Current, 0, 0, 3592);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(748, Current, 3592);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80002E9, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {745,0,0xFFFF};
