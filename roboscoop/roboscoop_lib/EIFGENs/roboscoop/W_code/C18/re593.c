...
extern EIF_TYPED_VALUE F593_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F593_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 592, Current, 0, 0, 3588);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(592, Current, 3588);
	RTIV(Current, RTAL);
	RTHOOK(1);
