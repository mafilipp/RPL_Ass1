...
extern EIF_TYPED_VALUE F78_1384(EIF_REFERENCE);
...
EIF_TYPED_VALUE F78_1384 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 77, Current, 0, 0, 1303);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(77, Current, 1303);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800024B, 0,0); /* Result */
	
	{
		static EIF_TYPE_INDEX typarr0[] = {587,0xFF11,0,0xFFFF};
	...
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(3706, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
