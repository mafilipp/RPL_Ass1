...
extern EIF_TYPED_VALUE F87_1519(EIF_REFERENCE);
...
RTOID (F87_1519)
EIF_TYPED_VALUE F87_1519 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 86, Current, 0, 0, 1431);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(86, Current, 1431);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800008A, 0,0); /* Result */
