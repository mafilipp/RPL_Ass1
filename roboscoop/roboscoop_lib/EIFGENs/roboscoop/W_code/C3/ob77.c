...
extern EIF_TYPED_VALUE F77_1383(EIF_REFERENCE);
...
EIF_TYPED_VALUE F77_1383 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 76, Current, 0, 0, 1302);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(76, Current, 1302);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80002B6, 0,0); /* Result */
	
	{
		static EIF_TYPE_INDEX typarr0[] = {694,0xFF11,0,0xFFFF};
