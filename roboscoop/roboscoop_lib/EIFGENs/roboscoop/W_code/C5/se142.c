...
extern void F142_1858(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F142_1858 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 141, Current, 8, 1, 1764);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(141, Current, 1764);
	RTIV(Current, RTAL);
	RTHOOK(1);
