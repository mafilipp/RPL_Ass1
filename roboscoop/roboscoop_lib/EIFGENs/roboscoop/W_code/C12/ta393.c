...
extern void F393_2239(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F393_2239 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 392, Current, 0, 1, 2205);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(392, Current, 2205);
	RTCC(arg1, 392, l_feature_name, 1, RTWCT(1943, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
