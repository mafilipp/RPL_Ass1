...
extern EIF_TYPED_VALUE F643_3324(EIF_REFERENCE);
extern EIF_TYPED_VALUE F643_3325(EIF_REFERENCE);
extern void F643_3331(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F643_3334(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F643_3335(EIF_REFERENCE);
extern EIF_TYPED_VALUE F643_3336(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F643_3324 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 642, Current, 0, 0, 4808);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(642, Current, 4808);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F643_3325 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 642, Current, 0, 0, 4809);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(642, Current, 4809);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F643_3331 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 642, Current, 0, 1, 4810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(642, Current, 4810);
	RTIV(Current, RTAL);
...
void F643_3334 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 642, Current, 0, 1, 4811);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(642, Current, 4811);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F643_3335 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 642, Current, 0, 0, 4812);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(642, Current, 4812);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F643_3336 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 642, Current, 2, 1, 4813);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(642, Current, 4813);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(3);
	RTDBGAL(Current, 0, 0xF8000282, 0,0); /* Result */
