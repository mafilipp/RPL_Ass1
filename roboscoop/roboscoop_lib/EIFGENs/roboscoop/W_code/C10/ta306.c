...
extern void F306_2239(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F306_2239 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 305, Current, 0, 1, 2202);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(305, Current, 2202);
	RTCC(arg1, 305, l_feature_name, 1, RTWCT(1943, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
