...
extern EIF_TYPED_VALUE F307_2464(EIF_REFERENCE);
extern EIF_TYPED_VALUE F307_2465(EIF_REFERENCE);
extern void F307_2466(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F307_2467(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F307_2468(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F307_2469(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F307_2470(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SEQUENCE}.readable */
EIF_TYPED_VALUE F307_2464 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 306, Current, 0, 0, 2736);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(306, Current, 2736);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SEQUENCE}.writable */
EIF_TYPED_VALUE F307_2465 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 306, Current, 0, 0, 2737);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(306, Current, 2737);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {SEQUENCE}.force */
void F307_2466 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 306, Current, 0, 1, 2738);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(306, Current, 2738);
	RTCC(arg1, 306, l_feature_name, 1, RTWCT(1984, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F307_2467 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 306, Current, 1, 1, 2739);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(306, Current, 2739);
	{
		...
		RTCC(arg1, 306, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1984, "item", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr2);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1948, dtype))(Current, ur1x);
		RTHOOK(8);
...
/* {SEQUENCE}.put */
void F307_2468 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 306, Current, 0, 1, 2740);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(306, Current, 2740);
	RTCC(arg1, 306, l_feature_name, 1, RTWCT(1984, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune */
void F307_2469 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 306, Current, 0, 1, 2741);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(306, Current, 2741);
	RTCC(arg1, 306, l_feature_name, 1, RTWCT(1984, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune_all */
void F307_2470 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 306, Current, 0, 1, 2742);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(306, Current, 2742);
	RTCC(arg1, 306, l_feature_name, 1, RTWCT(1984, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
