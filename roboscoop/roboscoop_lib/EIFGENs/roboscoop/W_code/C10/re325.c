...
extern EIF_TYPED_VALUE F325_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F325_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 324, Current, 0, 0, 3581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(324, Current, 3581);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000141, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {321,0,0xFFFF};
