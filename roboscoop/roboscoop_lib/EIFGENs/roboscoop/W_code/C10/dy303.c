...
extern EIF_TYPED_VALUE F303_3324(EIF_REFERENCE);
extern EIF_TYPED_VALUE F303_3325(EIF_REFERENCE);
extern void F303_3331(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F303_3334(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F303_3335(EIF_REFERENCE);
extern EIF_TYPED_VALUE F303_3336(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F303_3324 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 302, Current, 0, 0, 4754);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(302, Current, 4754);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F303_3325 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 302, Current, 0, 0, 4755);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(302, Current, 4755);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F303_3331 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 302, Current, 0, 1, 4756);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(302, Current, 4756);
	RTCC(arg1, 302, l_feature_name, 1, RTWCT(1984, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
void F303_3334 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 302, Current, 0, 1, 4757);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(302, Current, 4757);
	RTCC(arg1, 302, l_feature_name, 1, RTWCT(1984, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F303_3335 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 302, Current, 0, 0, 4758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(302, Current, 4758);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F303_3336 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 302, Current, 2, 1, 4759);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(302, Current, 4759);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
