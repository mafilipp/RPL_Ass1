...
extern EIF_TYPED_VALUE F828_2180(EIF_REFERENCE);
extern EIF_TYPED_VALUE F828_2181(EIF_REFERENCE);
extern EIF_TYPED_VALUE F828_2182(EIF_REFERENCE);
extern void F828_2183(EIF_REFERENCE);
extern void F828_2184(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F828_2180 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 827, Current, 0, 0, 2151);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(827, Current, 2151);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F828_2181 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F828_2182 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 827, Current, 0, 0, 2153);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(827, Current, 2153);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F828_2183 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 827, Current, 0, 0, 2154);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(827, Current, 2154);
	RTIV(Current, RTAL);
...
void F828_2184 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 827, Current, 0, 0, 2155);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(827, Current, 2155);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
