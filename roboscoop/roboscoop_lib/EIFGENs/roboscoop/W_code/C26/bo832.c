...
extern EIF_TYPED_VALUE F832_2268(EIF_REFERENCE);
extern void F832_7336(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F832_2268 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 831, Current, 0, 0, 2329);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(831, Current, 2329);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F832_7336 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 831, Current, 0, 7335);
	RTSA(dtype);
	RTME(dtype, 0);
