...
extern EIF_TYPED_VALUE F796_2188(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F796_2191(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F796_2193(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F796_2188 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 795, Current, 0, 1, 2195);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(795, Current, 2195);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	
	ui2_1 = arg1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1935, Dtype(Current)))(Current, ui2_1x)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {COLLECTION}.fill */
void F796_2191 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 795, Current, 1, 1, 2196);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(795, Current, 2196);
	{
		...
		RTCC(arg1, 795, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
...
void F796_2193 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 795, Current, 0, 1, 2197);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(795, Current, 2197);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	for (;;) {
		...
		RTHOOK(3);
		ui2_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1950, dtype))(Current, ui2_1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
