...
extern EIF_TYPED_VALUE F821_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F821_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 820, Current, 0, 0, 3594);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(820, Current, 3594);
	RTIV(Current, RTAL);
	RTHOOK(1);
