...
extern EIF_TYPED_VALUE F334_2268(EIF_REFERENCE);
extern void F334_7336(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F334_2268 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 333, Current, 0, 0, 2303);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(333, Current, 2303);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F334_7336 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 333, Current, 0, 7335);
	RTSA(dtype);
	RTME(dtype, 0);
