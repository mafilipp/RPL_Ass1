...
extern EIF_TYPED_VALUE F360_3155(EIF_REFERENCE);
...
EIF_TYPED_VALUE F360_3155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 359, Current, 0, 0, 3582);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(359, Current, 3582);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000164, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {356,0,0xFFFF};
