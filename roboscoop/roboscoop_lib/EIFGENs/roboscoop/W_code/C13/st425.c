...
extern void F425_2264(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F425_2265(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F425_2264 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 424, Current, 0, 1, 2295);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 2295);
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F425_2265 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 424, Current, 1, 1, 2296);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 2296);
	{
		EIF_TYPE_INDEX typarr0[] = {407,0,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[1] = RTWCT(1943, dtype, Dftype(Current));
		
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		RTCC(arg1, 424, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	{
		EIF_TYPE_INDEX typarr0[] = {426,0,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[1] = RTWCT(1943, dtype, Dftype(Current));
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(6);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2015, "item", arg1))(arg1)).it_b);
		ub1 = tb2;
	...
	for (;;) {
		...
		if (tb2) break;
		RTHOOK(9);
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1984, "item", loc1))(loc1)).it_b);
		ub1 = tb3;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1948, dtype))(Current, ub1x);
		RTHOOK(10);
