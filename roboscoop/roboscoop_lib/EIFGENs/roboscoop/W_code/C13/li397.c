...
extern EIF_TYPED_VALUE F397_3566(EIF_REFERENCE);
extern void F397_3567(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F397_3568(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F397_3569(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F397_3570(EIF_REFERENCE);
extern EIF_TYPED_VALUE F397_3571(EIF_REFERENCE);
extern EIF_TYPED_VALUE F397_3572(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F397_3566 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 396, Current, 1, 0, 5102);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(396, Current, 5102);
	RTIV(Current, RTAL);
...
body:;
	...
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1913, "item", loc1))(loc1)).it_b);
...
/* {LINKED_STACK}.force */
void F397_3567 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 396, Current, 0, 1, 5103);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(396, Current, 5103);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.extend */
void F397_3568 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 396, Current, 0, 1, 5104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(396, Current, 5104);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {LINKED_STACK}.put */
void F397_3569 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 396, Current, 0, 1, 5105);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(396, Current, 5105);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {LINKED_STACK}.remove */
void F397_3570 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 396, Current, 0, 0, 5106);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(396, Current, 5106);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(4);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2776, dtype))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
EIF_TYPED_VALUE F397_3571 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 396, Current, 1, 0, 5107);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(396, Current, 5107);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(5);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2775, dtype))(Current)).it_b);
		ub1 = tb2;
...
EIF_TYPED_VALUE F397_3572 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 396, Current, 3, 1, 5108);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(396, Current, 5108);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		RTHOOK(7);
		RTDBGAL(Current, 3, 0xF800018D, 0, 0); /* loc3 */
		...
		for (;;) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2775, dtype))(Current)).it_b);
			ub1 = tb2;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2709, "put_right", loc3))(loc3, ub1x);
			RTHOOK(12);
