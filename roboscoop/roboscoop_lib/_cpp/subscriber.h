...
public:
	...
	{
		ros::Subscriber sub = nh->subscribe <MESSAGE_TYPE>(topic_name, 1, boost::bind(&Subscriber::common_callback<MESSAGE_TYPE, CALLBACK_MESSAGE_TYPE>, this, _1, topic_name));
...
//printf("Callback started\n");
			...
			EIF_ENTER_EIFFEL;
			RTGC;
			if (topic_name == "roboscoop_ros/current_position")
			{
//				ROS_WARN ("Callback on %s", topic_name.c_str());		    
			}
